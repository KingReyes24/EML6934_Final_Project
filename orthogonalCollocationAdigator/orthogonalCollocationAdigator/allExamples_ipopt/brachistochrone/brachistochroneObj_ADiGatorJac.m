...
function obj = brachistochroneObj_ADiGatorJac(z)
global ADiGator_brachistochroneObj_ADiGatorJac
if isempty(ADiGator_brachistochroneObj_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_brachistochroneObj_ADiGatorJac.brachistochroneObj_ADiGatorJac.Gator1Data;
...
%User Line: obj = J;
obj.dz0_size = 165;
obj.dz0_location = Gator1Data.Index7;
end


function ADiGator_LoadData()
global ADiGator_brachistochroneObj_ADiGatorJac
ADiGator_brachistochroneObj_ADiGatorJac = load('brachistochroneObj_ADiGatorJac.mat');
return
end