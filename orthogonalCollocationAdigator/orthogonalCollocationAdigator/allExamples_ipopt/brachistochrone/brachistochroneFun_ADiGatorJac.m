...
function C = brachistochroneFun_ADiGatorJac(z)
global ADiGator_brachistochroneFun_ADiGatorJac
if isempty(ADiGator_brachistochroneFun_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_brachistochroneFun_ADiGatorJac.brachistochroneFun_ADiGatorJac.Gator1Data;
...
y.dz0 = stateLGR.dz0(Gator1Data.Index5);
y.f = stateLGR.f(:,2);
%User Line: y = stateLGR(:,2);
v.dz0 = stateLGR.dz0(Gator1Data.Index6);
v.f = stateLGR.f(:,3);
%User Line: v = stateLGR(:,3);
...
%User Line: %-----------------------------------------------------------------%
cada1f1dz0 = -sin(u.f(:)).*u.dz0;
cada1f1 = cos(u.f);
cada1td1 = zeros(80,1);
cada1td1(Gator1Data.Index7) = cada1f1(:).*v.dz0;
cada1td1(Gator1Data.Index8) = cada1td1(Gator1Data.Index8) + v.f(:).*cada1f1dz0;
cada1f2dz0 = cada1td1;
cada1f2 = v.f.*cada1f1;
cada1f3dz0 = cos(u.f(:)).*u.dz0;
cada1f3 = sin(u.f);
cada1td1 = zeros(80,1);
cada1td1(Gator1Data.Index9) = cada1f3(:).*v.dz0;
cada1td1(Gator1Data.Index10) = cada1td1(Gator1Data.Index10) + v.f(:).*cada1f3dz0;
cada1f4dz0 = cada1td1;
cada1f4 = v.f.*cada1f3;
cada1f5dz0 = cos(u.f(:)).*u.dz0;
cada1f5 = sin(u.f);
cada1f6dz0 = gravity.*cada1f5dz0;
cada1f6 = gravity*cada1f5;
cada1td1 = zeros(200,1);
cada1td1(Gator1Data.Index11) = cada1f2dz0;
cada1td1(Gator1Data.Index12) = cada1f4dz0;
cada1td1(Gator1Data.Index13) = cada1f6dz0;
diffeqRHS.dz0 = cada1td1;
diffeqRHS.f = [cada1f2 cada1f4 cada1f6];
%User Line: diffeqRHS = [v.*cos(u), v.*sin(u), gravity.*sin(u)];
%User Line: %-----------------------------------------------------------------%
...
%User Line: %-----------------------------------------------------------------%
cada1td1 = sparse(Gator1Data.Index14,Gator1Data.Index15,statePlusEnd.dz0,41,123);
cada1td1 = D*cada1td1;
cada1td1 = cada1td1(:);
diffeqLHS.dz0 = full(cada1td1(Gator1Data.Index16));
...
cada1f1dz0 = cada1td1;
cada1f1 = tf.f - t0.f;
cada1tempdz0 = cada1f1dz0(Gator1Data.Index17);
cada1tf1 = diffeqRHS.f(Gator1Data.Index18);
cada1td1 = zeros(440,1);
cada1td1(Gator1Data.Index19) = cada1tf1(:).*cada1tempdz0;
cada1td1(Gator1Data.Index20) = cada1td1(Gator1Data.Index20) + cada1f1.*diffeqRHS.dz0;
cada1f2dz0 = cada1td1;
cada1f2 = cada1f1*diffeqRHS.f;
cada1f3dz0 = cada1f2dz0./2;
cada1f3 = cada1f2/2;
cada1td1 = zeros(1040,1);
cada1td1(Gator1Data.Index21) = diffeqLHS.dz0;
...
%User Line: %-----------------------------------------------------------------%
cada1td1 = zeros(1041,1);
cada1td1(921) = tf.dz0;
cada1td1(Gator1Data.Index23) = defects.dz0;
C.dz0 = cada1td1;
C.f = [tf.f;defects.f];
%User Line: C = [tf; defects];
C.dz0_size = [121,165];
C.dz0_location = Gator1Data.Index24;
end


function ADiGator_LoadData()
global ADiGator_brachistochroneFun_ADiGatorJac
ADiGator_brachistochroneFun_ADiGatorJac = load('brachistochroneFun_ADiGatorJac.mat');
return
end