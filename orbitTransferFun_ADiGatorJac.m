...
%User Line: %-----------------------------------------------------------------%
cada1f1 = size(statePlusEnd.f,1);
stateF.dz0 = statePlusEnd.dz0(Gator1Data.Index12);
...
cada1td1(Gator1Data.Index13) = vtheta.dz0./r.f(:);
cada1td1(Gator1Data.Index14) = cada1td1(Gator1Data.Index14) + -vtheta.f(:)./r.f(:).^2.*r.dz0;
...
cada1td1 = zeros(256,1);
cada1td1(Gator1Data.Index18) = u1.f(:).*u3.dz0;
cada1td1(Gator1Data.Index19) = cada1td1(Gator1Data.Index19) + u3.f(:).*u1.dz0;
cada1f6dz0 = cada1td1;
cada1f6 = u3.f.*u1.f;
cada1tf1 = m.f(Gator1Data.Index20);
cada1td1 = zeros(384,1);
cada1td1(Gator1Data.Index21) = cada1f6dz0./cada1tf1(:);
cada1td1(Gator1Data.Index22) = cada1td1(Gator1Data.Index22) + -cada1f6(:)./m.f(:).^2.*m.dz0;
cada1f7dz0 = cada1td1;
cada1f7 = cada1f6./m.f;
cada1td1 = zeros(640,1);
cada1td1(Gator1Data.Index23) = cada1f5dz0;
cada1td1(Gator1Data.Index24) = cada1td1(Gator1Data.Index24) + cada1f7dz0;
vrdot.dz0 = cada1td1;
...
cada1f3 = cada1f2./r.f;
cada1td1 = zeros(256,1);
cada1td1(Gator1Data.Index30) = u2.f(:).*u3.dz0;
cada1td1(Gator1Data.Index31) = cada1td1(Gator1Data.Index31) + u3.f(:).*u2.dz0;
cada1f4dz0 = cada1td1;
cada1f4 = u3.f.*u2.f;
cada1tf1 = m.f(Gator1Data.Index32);
cada1td1 = zeros(384,1);
cada1td1(Gator1Data.Index33) = cada1f4dz0./cada1tf1(:);
cada1td1(Gator1Data.Index34) = cada1td1(Gator1Data.Index34) + -cada1f4(:)./m.f(:).^2.*m.dz0;
cada1f5dz0 = cada1td1;
cada1f5 = cada1f4./m.f;
cada1td1 = zeros(768,1);
cada1td1(Gator1Data.Index35) = cada1f3dz0;
cada1td1(Gator1Data.Index36) = cada1td1(Gator1Data.Index36) + cada1f5dz0;
...
cada1f2 = u2.f.^2;
cada1td1 = zeros(256,1);
cada1td1(Gator1Data.Index51) = cada1f1dz0;
cada1td1(Gator1Data.Index52) = cada1td1(Gator1Data.Index52) + cada1f2dz0;
paths.dz0 = cada1td1;
